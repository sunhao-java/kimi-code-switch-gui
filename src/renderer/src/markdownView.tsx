...
export function MarkdownView(props: {
  ...
  const showHeader = Boolean(props.title) || Boolean(props.onCopy) || Boolean(props.headerExtra);
  ...
  return (
    <div className="code-panel">
      ...
      <div className="markdown-view" role="region" aria-label={props.title ?? "markdown"}>
